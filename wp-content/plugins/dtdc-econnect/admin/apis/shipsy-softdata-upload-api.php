...
foreach ( $request as $idx => $consignment ) {
	...
	$data_to_send_array = array(
		...
		'cod_favor_of'               => '',
		'pieces_detail'              => array(),
		'cod_collection_mode'        => ( 0.0 === (float) $consignment['cod-amount'] ? '' : 'CASH' ),
		'cod_amount'                 => ( 'cod' === $consignment['cod-collection-mode'] ? $consignment['cod-amount'] : 0 ),
...
$request     = get_shipsy_request_handler();
